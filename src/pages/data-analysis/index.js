...
function DataAnalysis() {
  ...
  const sampling = [
    { item: "Over-sampling", description: "" },
    { item: "Under-sampling", description: "" },
    { item: "Borderline SMOTE", description: "" },
    { item: "SMOTE", description: "" },
    { item: "ADASYN", description: "" },
  ]

  const outlierTreatment = [
    { item: "Z-score method", description: "" },
    { item: "Robust Z-score", description: "" },
    { item: "I.Q.R method", description: "" },
    { item: "Winsorization method (Percentile Capping)", description: "" },
    { item: "DBSCAN Clustering", description: "" },
  ]

  const outlierRemoval = [
    { item: "Deleting observations", description: "" },
    { item: "Transforming values", description: "" },
    { item: "Imputation", description: "" },
    { item: "Separately treating", description: "" },
